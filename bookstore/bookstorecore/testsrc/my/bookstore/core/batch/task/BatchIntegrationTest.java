...
{
	private static final String BOOKSTORE = "bookstoreProductCatalog";
	...
	public void testBasicProduct() throws Exception
	{
		...
		Assert.assertEquals("bookstoreProductCatalog", product.getCatalogVersion().getCatalog().getId());
	}
	...
	public void testPrice() throws Exception
	{
		...
		try
		{
			...
			Assert.assertEquals("bookstoreProductCatalog", prize.getCatalogVersion().getCatalog().getId());
		}
		finally
		{
	...
	public void testMedia() throws Exception
	{
		...
		Assert.assertEquals("bookstoreProductCatalog", container.getCatalogVersion().getCatalog().getId());
	}
	...
	public void testVariant() throws Exception
	{
		processFile(productId, "base_product-", new ProductContent()
		{
			...
			public void writeContent(final PrintWriter writer) throws IOException
			{
				writer.print("BookstoreSizeVariantProduct");
		...
		final BookstoreSizeVariantProductModel variant = (BookstoreSizeVariantProductModel) productService.getProductForCode(variantId
				.toString());
		Assert.assertEquals("BookstoreSizeVariantProduct", product.getVariantType().getCode());
	...
	protected void verifyMedia(final MediaModel media, final String format)
	{
		...
		Assert.assertEquals("bookstoreProductCatalog", media.getCatalogVersion().getCatalog().getId());
